...
public class GreenPanelController implements ActionListener {

    private Game gameModel;

    public GreenPanelController(Game g) {
        this.gameModel = g;
    }
        ...
        if (squareInBoard(e.getSource())) {
            ...
            switch (squareButton.getPanelType()) {
                case CREATION_SHELF:
                    ...
                    Piece greenPiece = gameModel.getCurrentPlayer().hand.getPiece(squareButton);
                    ...
                    if (greenPiece instanceof PlayerPiece) {
                        PlayerPiece selected = (PlayerPiece) greenPiece;
